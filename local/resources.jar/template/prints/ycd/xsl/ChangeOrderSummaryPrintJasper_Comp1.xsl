	...
	<API>   
		...
		<xsl:value-of select="/Order/@OrderHeaderKey"/>
			...
			<Template>
				...
				<PriceInfo Currency="" />
				<OrderLines>
					<OrderLine   ItemGroupCode="" OpenQty="" OrderedQty="" ShipNode="" Status="" PrimeLineNo=""  OrderLineKey=""  >
					<LinePriceInfo TaxableFlag="" UnitPrice=""/>
					<LineOverallTotals Charges="" Discount=""
					ExtendedPrice="" LineTotal=""
					OptionPrice="" PricingQty="" Tax="" UnitPrice=""/>
					<LineCharges/>
					<LineTaxes/>				<PersonInfoShipTo PersonInfoKey=""/>
	...
	<API>
		...
		<Input>
			<GetPrinter>
				...
				<xsl:text>PRINT_CHANGEORDER_SUMMARY</xsl:text>
				</xsl:attribute>
