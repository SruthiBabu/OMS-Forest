	...
	<xsl:template match="Print | Item">
		<PrintDocuments>
			...
			<xsl:attribute name="PrintName">
				<xsl:text>HazmatSKULabel</xsl:text>
			</xsl:attribute>
			
		<PrintDocument>
			<xsl:attribute name="BeforeChildrenPrintDocumentId">
				<xsl:text>HAZMAT_SKU_LABEL</xsl:text>
			</xsl:attribute>
			...
			<InputData>
				...
				<Template>
                                    <Item ItemID="" ItemKey="" OrganizationCode="" UnitOfMeasure="" Modifyuserid=""  >
                                        <HazmatInformation HazardClass="" Label="" PackingGroup="" ProperShippingName="" UNNumber="" /> 
                                    </Item>
				</Template>
			</InputData>                        
		</PrintDocument>
