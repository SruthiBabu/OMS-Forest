...
<xsl:template match="/">		
		<xsl:element name="ReserveItemInventoryList">		
			...
			<xsl:attribute name="TotalDemand">Y</xsl:attribute>
			<xsl:attribute name="PublishedTime">
				<xsl:value-of select="/Items/Item/TotalDemand/@PublishedTime"/>
			</xsl:attribute>
			<xsl:attribute name="IgnoreCapacityUpdate">
				<xsl:value-of select="/Items/@IgnoreCapacityUpdate"/>
			</xsl:attribute>
				<xsl:for-each select="/Items/Item/TotalDemand/Demand">
